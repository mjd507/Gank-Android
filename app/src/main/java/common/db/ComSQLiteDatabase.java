...
public class ComSQLiteDatabase {
    ...
    private com.android.common.db.DBHelper mDatabaseHelper = null;
    ...
    public ComSQLiteDatabase(Context context) {
        ...
        this.mDatabaseHelper = new com.android.common.db.DBHelper(context, params.getDbName(), null, params.getDbVersion());

    }

    public ComSQLiteDatabase(Context context, DBParams params) {
        this.mDatabaseHelper = new com.android.common.db.DBHelper(context, params.getDbName(), null, params.getDbVersion(), null);
    }

    public ComSQLiteDatabase(Context context, DBUpdateListener dbUpdateListener) {
        DBParams params = new DBParams();
        this.mDatabaseHelper = new com.android.common.db.DBHelper(context, params.getDbName(), null, params.getDbVersion(), dbUpdateListener);
    }
